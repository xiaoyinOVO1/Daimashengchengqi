package com.it.builder;



import com.it.bean.Constants;
import com.it.bean.FieldInfo;
import com.it.bean.TableInfo;
...
public class BuildTable {
   ...
   static {
    ...
    public static List<TableInfo> getTables() {
        ...
        try {
            ...
            while (tableResults.next()) {
                ...
                fieldInfoList = readFieldInfo(tableInfo, fieldInfoMap);
    ...
    private static String processField(Boolean uperCaseFirstLetter, String field) {
        ...
        sb.append(uperCaseFirstLetter ? StringUtils.uperCaseFiretleLateer(fields[0]) : fields[0]);
        for (int i = 1, len = fields.length; i < len; i++) {
            sb.append(StringUtils.uperCaseFiretleLateer(fields[i]));
        }
        return sb.toString();
    }
